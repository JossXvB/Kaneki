...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Advertencia*', body: 'Kaneki', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/xs.kanekii/'}}}}, aa);
