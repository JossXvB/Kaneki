...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Advertencia*', body: '𝙆𝙖𝙣𝙚𝙠𝙞𝙯𝙭𝙭⚡', thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/xs.kanekii/'}}}}, aa);
